namespace StrongMe.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null, string code = null)
        {
            ...
            PageContext.ViewData["Code"] = code;
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, Code = Input.Code };
                var result = await _userManager.CreateAsync(user, Input.Password);
                if (result.Succeeded)
                {
                    _userManager.AddToRoleAsync(user, isInstructor ? GlobalConstants.InstructurRoleName : GlobalConstants.TraineeRoleName);
